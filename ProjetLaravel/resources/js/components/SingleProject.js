...
class SingleProject extends Component {
    constructor (props){
        ...
        this.handleFlieldChange = this.handleFlieldChange.bind(this)
        this.handleAddNewTask = this.handleAddNewTask.bind(this)
        this.hasErrorFor = this.gasErrorFor.bind(this)
    }
    ...
    handleMarkProjectAsCompleted(taskId){
